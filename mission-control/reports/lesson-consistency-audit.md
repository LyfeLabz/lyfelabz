...
| `lesson_phases-of-the-moon.html` | Yes | `6.MS-ESS1-1a`, `MS-ESS1-2` | Badges + expand | Present | `📋 MA STE Standards · Grade 6` ✓ | Code corrected to `6.MS-ESS1-1a` (June 2026) | — | — |
| `lesson_sun-earth-moon.html` | Yes | `6.MS-ESS1-1a`, `MS-ESS1-2` | Badges + expand | Present | `📋 MA STE Standards · Grade 6` ✓ | Code corrected to `6.MS-ESS1-1a` (June 2026) | — | — |
| `lesson_biological-evolution.html` | Yes | `MS-LS4-4`, `MS-LS4-1`, `MS-LS4-2` | Badges + expand | Present | `📋 MA STE Standards · Grade 7–8` ✓ | Invalid `MS-LS4-6` badge removed (June 2026). Code format uses NGSS-style `MS-LS4-X` without grade prefix. Grade label correctly says 7–8. | Standardize to grade-prefixed MA codes | Medium |
...
| `lesson_continental-drift.html` | Yes | `6.ESS2-3`, `SEP-4` | Badges + expand | Present | `MA STE Standards · Grade 6` (no 📋; uses HTML `&middot;` not Unicode `·`) | Invalid `6.ESS2-2` badge removed (June 2026). No 📋 emoji on stem-focus-label; `SEP-4` is a practice code. | Add 📋; switch `&middot;` to `·` | Medium |
| `lesson_layers-of-time.html` | Yes | `6.ESS1-4`, `6.ESS2-3` | Badges + expand | Present | `📋 MA STE Standards · Grade 6` ✓ | Invalid `6.ESS2-2` badge removed (June 2026). Code format uses `6.ESS-X` without `MS-`. | Acceptable within Earth Science cluster | Low |
