/*
 * digital-signals - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_digital-signals.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=digital-signals --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_digital-signals.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=digital-signals --target=v2
-->
`;

module.exports = {
  slug: "digital-signals",
  canonicalSource: "lesson-sources/lesson_digital-signals.html",
  outputs: {
    v1: "lesson_digital-signals.html",
    v2: "app/lessons/lesson_digital-signals.html",
  },
