/*
 * designing-to-scale - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_designing-to-scale.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=designing-to-scale --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_designing-to-scale.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=designing-to-scale --target=v2
-->
`;

module.exports = {
  slug: "designing-to-scale",
  canonicalSource: "lesson-sources/lesson_designing-to-scale.html",
  outputs: {
    v1: "lesson_designing-to-scale.html",
    v2: "app/lessons/lesson_designing-to-scale.html",
  },
