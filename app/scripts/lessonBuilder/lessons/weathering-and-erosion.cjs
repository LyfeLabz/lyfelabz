/*
 * weathering-and-erosion - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_weathering-and-erosion.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=weathering-and-erosion --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_weathering-and-erosion.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=weathering-and-erosion --target=v2
-->
`;

module.exports = {
  slug: "weathering-and-erosion",
  canonicalSource: "lesson-sources/lesson_weathering-and-erosion.html",
  outputs: {
    v1: "lesson_weathering-and-erosion.html",
    v2: "app/lessons/lesson_weathering-and-erosion.html",
  },
