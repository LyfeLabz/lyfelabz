/*
 * heat-transfer - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_heat-transfer.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=heat-transfer --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_heat-transfer.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=heat-transfer --target=v2
-->
`;

module.exports = {
  slug: "heat-transfer",
  canonicalSource: "lesson-sources/lesson_heat-transfer.html",
  outputs: {
    v1: "lesson_heat-transfer.html",
    v2: "app/lessons/lesson_heat-transfer.html",
  },
