/*
 * continental-drift - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_continental-drift.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=continental-drift --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_continental-drift.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=continental-drift --target=v2
-->
`;

module.exports = {
  slug: "continental-drift",
  canonicalSource: "lesson-sources/lesson_continental-drift.html",
  outputs: {
    v1: "lesson_continental-drift.html",
    v2: "app/lessons/lesson_continental-drift.html",
  },
