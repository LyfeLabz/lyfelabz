/*
 * parts-of-an-ecosystem - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_parts-of-an-ecosystem.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=parts-of-an-ecosystem --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_parts-of-an-ecosystem.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=parts-of-an-ecosystem --target=v2
-->
`;

module.exports = {
  slug: "parts-of-an-ecosystem",
  canonicalSource: "lesson-sources/lesson_parts-of-an-ecosystem.html",
  outputs: {
    v1: "lesson_parts-of-an-ecosystem.html",
    v2: "app/lessons/lesson_parts-of-an-ecosystem.html",
  },
