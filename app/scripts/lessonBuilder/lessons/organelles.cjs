/*
 * organelles - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_organelles.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=organelles --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_organelles.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=organelles --target=v2
-->
`;

module.exports = {
  slug: "organelles",
  canonicalSource: "lesson-sources/lesson_organelles.html",
  outputs: {
    v1: "lesson_organelles.html",
    v2: "app/lessons/lesson_organelles.html",
  },
