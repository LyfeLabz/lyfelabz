/*
 * sun-earth-moon - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_sun-earth-moon.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=sun-earth-moon --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_sun-earth-moon.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=sun-earth-moon --target=v2
-->
`;

module.exports = {
  slug: "sun-earth-moon",
  canonicalSource: "lesson-sources/lesson_sun-earth-moon.html",
  outputs: {
    v1: "lesson_sun-earth-moon.html",
    v2: "app/lessons/lesson_sun-earth-moon.html",
  },
  ...
  sharedRequiredSignatures: [
    ...
    "id=\"sem-quiz-questions\"",
    "id=\"sem-submit-btn\"",
    "id=\"sem-score\"",
    "id=\"sem-submit-status\"",
    "id=\"sem-thinking\"",
    "id=\"sem-think-model\"",
  ],
};
