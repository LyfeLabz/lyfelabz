/*
 * engineering-systems - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_engineering-systems.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=engineering-systems --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_engineering-systems.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=engineering-systems --target=v2
-->
`;

module.exports = {
  slug: "engineering-systems",
  canonicalSource: "lesson-sources/lesson_engineering-systems.html",
  outputs: {
    v1: "lesson_engineering-systems.html",
    v2: "app/lessons/lesson_engineering-systems.html",
  },
