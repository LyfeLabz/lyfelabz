/*
 * ecosystem-stability - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_ecosystem-stability.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=ecosystem-stability --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_ecosystem-stability.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=ecosystem-stability --target=v2
-->
`;

module.exports = {
  slug: "ecosystem-stability",
  canonicalSource: "lesson-sources/lesson_ecosystem-stability.html",
  outputs: {
    v1: "lesson_ecosystem-stability.html",
    v2: "app/lessons/lesson_ecosystem-stability.html",
  },
