/*
 * body-systems - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_body-systems.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=body-systems --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_body-systems.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=body-systems --target=v2
-->
`;

module.exports = {
  slug: "body-systems",
  canonicalSource: "lesson-sources/lesson_body-systems.html",
  outputs: {
    v1: "lesson_body-systems.html",
    v2: "app/lessons/lesson_body-systems.html",
  },
