/*
 * communication-systems - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_communication-systems.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=communication-systems --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_communication-systems.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=communication-systems --target=v2
-->
`;

module.exports = {
  slug: "communication-systems",
  canonicalSource: "lesson-sources/lesson_communication-systems.html",
  outputs: {
    v1: "lesson_communication-systems.html",
    v2: "app/lessons/lesson_communication-systems.html",
  },
