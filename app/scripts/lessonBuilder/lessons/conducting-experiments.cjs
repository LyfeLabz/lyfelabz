/*
 * conducting-experiments - declarative lesson build configuration.
 *
...
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=conducting-experiments --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_conducting-experiments.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=conducting-experiments --target=v2
-->
`;

module.exports = {
  slug: "conducting-experiments",
  canonicalSource: "lesson-sources/lesson_conducting-experiments.html",
  outputs: {
    v1: "lesson_conducting-experiments.html",
    v2: "app/lessons/lesson_conducting-experiments.html",
  },
