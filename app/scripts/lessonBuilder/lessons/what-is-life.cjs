/*
 * what-is-life - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_what-is-life.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=what-is-life --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_what-is-life.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=what-is-life --target=v2
-->
`;

module.exports = {
  slug: "what-is-life",
  canonicalSource: "lesson-sources/lesson_what-is-life.html",
  outputs: {
    v1: "lesson_what-is-life.html",
    v2: "app/lessons/lesson_what-is-life.html",
  },
