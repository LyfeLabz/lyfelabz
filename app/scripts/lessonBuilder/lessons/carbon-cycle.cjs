/*
 * carbon-cycle - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_carbon-cycle.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=carbon-cycle --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_carbon-cycle.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=carbon-cycle --target=v2
-->
`;

module.exports = {
  slug: "carbon-cycle",
  canonicalSource: "lesson-sources/lesson_carbon-cycle.html",
  outputs: {
    v1: "lesson_carbon-cycle.html",
    v2: "app/lessons/lesson_carbon-cycle.html",
  },
