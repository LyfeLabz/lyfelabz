/*
 * measuring-matter - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_measuring-matter.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=measuring-matter --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_measuring-matter.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=measuring-matter --target=v2
-->
`;

module.exports = {
  slug: "measuring-matter",
  canonicalSource: "lesson-sources/lesson_measuring-matter.html",
  outputs: {
    v1: "lesson_measuring-matter.html",
    v2: "app/lessons/lesson_measuring-matter.html",
  },
