/*
 * hotspot-volcanoes - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_hotspot-volcanoes.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=hotspot-volcanoes --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_hotspot-volcanoes.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=hotspot-volcanoes --target=v2
-->
`;

module.exports = {
  slug: "hotspot-volcanoes",
  canonicalSource: "lesson-sources/lesson_hotspot-volcanoes.html",
  outputs: {
    v1: "lesson_hotspot-volcanoes.html",
    v2: "app/lessons/lesson_hotspot-volcanoes.html",
  },
