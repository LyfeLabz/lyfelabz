/*
 * energy-flow - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_energy-flow.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=energy-flow --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_energy-flow.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=energy-flow --target=v2
-->
`;

module.exports = {
  slug: "energy-flow",
  canonicalSource: "lesson-sources/lesson_energy-flow.html",
  outputs: {
    v1: "lesson_energy-flow.html",
    v2: "app/lessons/lesson_energy-flow.html",
  },
