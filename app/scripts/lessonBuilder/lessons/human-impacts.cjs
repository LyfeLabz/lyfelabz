/*
 * human-impacts - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_human-impacts.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=human-impacts --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_human-impacts.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=human-impacts --target=v2
-->
`;

module.exports = {
  slug: "human-impacts",
  canonicalSource: "lesson-sources/lesson_human-impacts.html",
  outputs: {
    v1: "lesson_human-impacts.html",
    v2: "app/lessons/lesson_human-impacts.html",
  },
