/*
 * energy-transfer - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_energy-transfer.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=energy-transfer --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_energy-transfer.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=energy-transfer --target=v2
-->
`;

module.exports = {
  slug: "energy-transfer",
  canonicalSource: "lesson-sources/lesson_energy-transfer.html",
  outputs: {
    v1: "lesson_energy-transfer.html",
    v2: "app/lessons/lesson_energy-transfer.html",
  },
