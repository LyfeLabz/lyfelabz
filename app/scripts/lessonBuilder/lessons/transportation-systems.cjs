/*
 * transportation-systems - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_transportation-systems.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=transportation-systems --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_transportation-systems.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=transportation-systems --target=v2
-->
`;

module.exports = {
  slug: "transportation-systems",
  canonicalSource: "lesson-sources/lesson_transportation-systems.html",
  outputs: {
    v1: "lesson_transportation-systems.html",
    v2: "app/lessons/lesson_transportation-systems.html",
  },
