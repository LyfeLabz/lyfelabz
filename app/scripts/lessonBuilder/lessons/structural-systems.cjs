/*
 * structural-systems - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_structural-systems.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=structural-systems --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_structural-systems.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=structural-systems --target=v2
-->
`;

module.exports = {
  slug: "structural-systems",
  canonicalSource: "lesson-sources/lesson_structural-systems.html",
  outputs: {
    v1: "lesson_structural-systems.html",
    v2: "app/lessons/lesson_structural-systems.html",
  },
