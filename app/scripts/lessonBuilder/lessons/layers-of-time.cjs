/*
 * layers-of-time - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_layers-of-time.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=layers-of-time --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_layers-of-time.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=layers-of-time --target=v2
-->
`;

module.exports = {
  slug: "layers-of-time",
  canonicalSource: "lesson-sources/lesson_layers-of-time.html",
  outputs: {
    v1: "lesson_layers-of-time.html",
    v2: "app/lessons/lesson_layers-of-time.html",
  },
