/*
 * types-of-volcanoes - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_types-of-volcanoes.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=types-of-volcanoes --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_types-of-volcanoes.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=types-of-volcanoes --target=v2
-->
`;

module.exports = {
  slug: "types-of-volcanoes",
  canonicalSource: "lesson-sources/lesson_types-of-volcanoes.html",
  outputs: {
    v1: "lesson_types-of-volcanoes.html",
    v2: "app/lessons/lesson_types-of-volcanoes.html",
  },
