/*
 * engineering-design - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_engineering-design.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=engineering-design --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_engineering-design.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=engineering-design --target=v2
-->
`;

module.exports = {
  slug: "engineering-design",
  canonicalSource: "lesson-sources/lesson_engineering-design.html",
  outputs: {
    v1: "lesson_engineering-design.html",
    v2: "app/lessons/lesson_engineering-design.html",
  },
