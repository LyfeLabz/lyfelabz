/*
 * renewable-and-nonrenewable-resources - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_renewable-and-nonrenewable-resources.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=renewable-and-nonrenewable-resources --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_renewable-and-nonrenewable-resources.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=renewable-and-nonrenewable-resources --target=v2
-->
`;
...
module.exports = {
  ...
  outputs: {
    ...
    v2: "app/lessons/lesson_renewable-and-nonrenewable-resources.html",
  },
