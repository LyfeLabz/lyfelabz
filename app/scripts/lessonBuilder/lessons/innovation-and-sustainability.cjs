/*
 * innovation-and-sustainability - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_innovation-and-sustainability.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=innovation-and-sustainability --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_innovation-and-sustainability.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=innovation-and-sustainability --target=v2
-->
`;

module.exports = {
  slug: "innovation-and-sustainability",
  canonicalSource: "lesson-sources/lesson_innovation-and-sustainability.html",
  outputs: {
    v1: "lesson_innovation-and-sustainability.html",
    v2: "app/lessons/lesson_innovation-and-sustainability.html",
  },
