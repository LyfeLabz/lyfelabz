/*
 * wave-behavior - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_wave-behavior.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=wave-behavior --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_wave-behavior.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=wave-behavior --target=v2
-->
`;

module.exports = {
  slug: "wave-behavior",
  canonicalSource: "lesson-sources/lesson_wave-behavior.html",
  outputs: {
    v1: "lesson_wave-behavior.html",
    v2: "app/lessons/lesson_wave-behavior.html",
  },
