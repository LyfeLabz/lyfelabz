/*
 * technology-and-society - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_technology-and-society.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=technology-and-society --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_technology-and-society.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=technology-and-society --target=v2
-->
`;

module.exports = {
  slug: "technology-and-society",
  canonicalSource: "lesson-sources/lesson_technology-and-society.html",
  outputs: {
    v1: "lesson_technology-and-society.html",
    v2: "app/lessons/lesson_technology-and-society.html",
  },
