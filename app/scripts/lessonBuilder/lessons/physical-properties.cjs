/*
 * physical-properties - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_physical-properties.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=physical-properties --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_physical-properties.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=physical-properties --target=v2
-->
`;

module.exports = {
  slug: "physical-properties",
  canonicalSource: "lesson-sources/lesson_physical-properties.html",
  outputs: {
    v1: "lesson_physical-properties.html",
    v2: "app/lessons/lesson_physical-properties.html",
  },
