/*
 * gravity - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_gravity.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=gravity --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_gravity.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=gravity --target=v2
-->
`;

module.exports = {
  slug: "gravity",
  canonicalSource: "lesson-sources/lesson_gravity.html",
  outputs: {
    v1: "lesson_gravity.html",
    v2: "app/lessons/lesson_gravity.html",
  },
  ...
  sharedRequiredSignatures: [
    ...
    "id=\"grav-quiz-questions\"",
    "id=\"grav-submit-btn\"",
    "id=\"grav-score\"",
    "id=\"grav-submit-status\"",
    "id=\"grav-thinking\"",
    "id=\"grav-think-model\"",
  ],
};
