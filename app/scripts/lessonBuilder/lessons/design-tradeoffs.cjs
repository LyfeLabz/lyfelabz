/*
 * design-tradeoffs - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_design-tradeoffs.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=design-tradeoffs --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_design-tradeoffs.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=design-tradeoffs --target=v2
-->
`;

module.exports = {
  slug: "design-tradeoffs",
  canonicalSource: "lesson-sources/lesson_design-tradeoffs.html",
  outputs: {
    v1: "lesson_design-tradeoffs.html",
    v2: "app/lessons/lesson_design-tradeoffs.html",
  },
