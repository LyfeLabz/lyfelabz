/*
 * phases-of-the-moon - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_phases-of-the-moon.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=phases-of-the-moon --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_phases-of-the-moon.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=phases-of-the-moon --target=v2
-->
`;

module.exports = {
  slug: "phases-of-the-moon",
  canonicalSource: "lesson-sources/lesson_phases-of-the-moon.html",
  outputs: {
    v1: "lesson_phases-of-the-moon.html",
    v2: "app/lessons/lesson_phases-of-the-moon.html",
  },
