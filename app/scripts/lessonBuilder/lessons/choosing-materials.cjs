/*
 * choosing-materials - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_choosing-materials.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=choosing-materials --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_choosing-materials.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=choosing-materials --target=v2
-->
`;

module.exports = {
  slug: "choosing-materials",
  canonicalSource: "lesson-sources/lesson_choosing-materials.html",
  outputs: {
    v1: "lesson_choosing-materials.html",
    v2: "app/lessons/lesson_choosing-materials.html",
  },
