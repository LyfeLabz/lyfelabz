/*
 * photosynthesis - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_photosynthesis.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=photosynthesis --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_photosynthesis.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=photosynthesis --target=v2
-->
`;

module.exports = {
  slug: "photosynthesis",
  canonicalSource: "lesson-sources/lesson_photosynthesis.html",
  outputs: {
    v1: "lesson_photosynthesis.html",
    v2: "app/lessons/lesson_photosynthesis.html",
  },
