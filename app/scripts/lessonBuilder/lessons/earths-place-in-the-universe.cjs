/*
 * earths-place-in-the-universe - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_earths-place-in-the-universe.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=earths-place-in-the-universe --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_earths-place-in-the-universe.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=earths-place-in-the-universe --target=v2
-->
`;

module.exports = {
  slug: "earths-place-in-the-universe",
  canonicalSource: "lesson-sources/lesson_earths-place-in-the-universe.html",
  outputs: {
    v1: "lesson_earths-place-in-the-universe.html",
    v2: "app/lessons/lesson_earths-place-in-the-universe.html",
  },
  ...
  expectedContexts: {
    ...
    "legacy-classroom-localstorage": "html",
  ...
  sharedRequiredSignatures: [
    ...
    "id=\"epu-quiz-questions\"",
    "id=\"epu-submit-btn\"",
    "id=\"epu-score\"",
    "id=\"epu-submit-status\"",
    "id=\"epu-thinking\"",
    "id=\"epu-think-model\"",
  ],
};
