/*
 * chemical-reactions - declarative lesson build configuration.
 *
...
Canonical source: lesson-sources/lesson_chemical-reactions.html
Build target: v1
Regenerate: npm --prefix app run lessons:build -- --only=chemical-reactions --target=v1
-->
`;
...
Canonical source: lesson-sources/lesson_chemical-reactions.html
Build target: v2
Regenerate: npm --prefix app run lessons:build -- --only=chemical-reactions --target=v2
-->
`;

module.exports = {
  slug: "chemical-reactions",
  canonicalSource: "lesson-sources/lesson_chemical-reactions.html",
  outputs: {
    v1: "lesson_chemical-reactions.html",
    v2: "app/lessons/lesson_chemical-reactions.html",
  },
