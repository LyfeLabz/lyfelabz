...
(() => {
  ...
  function mapIndexSelectionsToResponses(indexSelections) {
    ...
    for (let qi = 0; qi < indexSelections.length; qi++) {
      ...
      if (idx === null || idx === void 0) continue;
  ...
  function detectAssignmentId(win) {
    try {
  ...
  function parseFinalizeResult(raw) {
  ...
  function parseAttemptSummary(raw) {
  ...
  function createBackedCallables(functions) {
  ...
  function installInertRuntime(win, hasContext) {
    const runtime = {
      version: VERSION,
